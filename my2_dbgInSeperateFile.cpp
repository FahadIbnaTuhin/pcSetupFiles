// Do this and then delete this: 

// paste inside the debug.h this: 
...
// and now inside this file in sublime, paste this code(just need to use -DLOCAL)
// c++14.sublime-build
// {
// "cmd" : ["g++ -DLOCAL -std=c++17 $file_name -o $file_base_name && timeout 4s ./$file_base_name<inputf.in>outputf.in"], 
// "selector" : "source.c",
// "shell": true,
